...
targets::tar_target(
  name = ae_attendance_raw, # name of dataset
  command = ae_attendance_raw(nhsr_dataset_name) # pipeline function
),
...
targets::tar_target(
  name = trust_ods_codes_raw, # name of dataset
  command = trust_ods_codes_raw(file_url) # pipeline function
),
